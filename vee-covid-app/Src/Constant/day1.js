export default class day1 {
    ...
    static Day = "Day - 1"
    static PageTitle = "What to do in my Day 1 Quarantine?"

    //part 1
    static part1Title = "Physical Excercises"
    static part1SubTitle = "QUARANTINE COVID"
    static part1Content = "1. Squat Touches * 5\n2. Knee-in-Lunge R*5 L*5\n3. Pile Punch * 5\n4. Sukhasana (20 breathes)"
    ...
    static part3Content = "#On rising - Soaked Almonds,Raisins\n#Breakfast - Avul with Peanuts\nLemon/Orange Juice\n#Lunch - Dal Rice + Pickle\nHandful of Peanuts\n#Dinner - Wheat Rotti\nSukku Tea"
